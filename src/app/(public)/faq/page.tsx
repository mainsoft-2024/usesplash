...
const faqs: { category: string; q: string; a: string }[] = [
  ...
  { category: "요금제", q: "Pro 플랜으로 업그레이드하면 무엇이 달라지나요?", a: "무제한 프로젝트, 하루 100회 생성, 고해상도 출력 등의 프리미엄 기능을 이용할 수 있습니다. SVG 변환·배경 제거는 출시 예정입니다." },
  ...
  { category: "로고 생성", q: "어떤 형식으로 내보내기할 수 있나요?", a: "현재는 PNG 다운로드와 크롭을 지원합니다. SVG 벡터 변환·배경 제거 PNG는 출시 예정입니다." },
