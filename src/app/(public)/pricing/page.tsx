...
const plans = [
  ...
  },
  {
    ...
    price: "₩19,900",
    period: "/월",
    features: ["무제한 프로젝트", "일일 생성 100회", "AI 인터뷰", "버전 관리", "우선 생성 큐", "고해상도 출력", "프리미엄 내보내기(SVG·배경제거) 출시 예정"],
    cta: "Pro 시작하기",
...
const comparison = [
  ...
  { feature: "SVG 변환", free: "—", pro: "출시 예정", enterprise: "출시 예정" },
  { feature: "배경 제거", free: "—", pro: "출시 예정", enterprise: "출시 예정" },
